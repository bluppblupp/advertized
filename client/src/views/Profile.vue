...
<div class="container py-3 justify-content-center align-items-center">
  ...
  <ul class="list-group justify-content-center p-3 mb-5 bg-white rounded">
    ...
    <li class="list-group-item justify-content-center">
      ...
      <!-- List Item-->
      <li class="list-group-item justify-content-center">
        <div class="media justify-content-center align-items-center flex-column flex-lg-row p-3">
          <div class="media-body order-2 order-lg-1">
...
export default {
 ...
 /* computed: {
    adminTimes() {
      return this.adverts.filter(function (advert) {
        return advert.admin === this.name;
      });
    },
  }, */
